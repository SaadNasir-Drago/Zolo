    ...
    try {
      if (isSignIn) {
        ...
        const response = await axios.post(
          "https://railway.app/project/2ff822b9-c7df-426d-b0a1-a2b5b874b4e7/api/auth/login",
          {
        ...
        // Register request
        await axios.post(
          "https://railway.app/project/2ff822b9-c7df-426d-b0a1-a2b5b874b4e7/api/auth/register",
          {
